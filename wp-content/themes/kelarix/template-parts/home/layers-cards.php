<?php
/**
 * Layers section — cards grid + CTA.
 * Rendered outside the hero-block wrapper so the shared backdrop
 * ends right before the cards begin.
 *
 * @package Kelarix
 */

// Decorative outline icons (same set used in layers.php).
