<?php
/**
 * Proof: Case Studies accordion (all items expandable, Retail open by default).
 *
 * @package Kelarix
 */
$defaults = array(
	...
	2 => array(
		...
		'explores'    => "Distributor demand signals\nStockout patterns\nProduction and supply gaps\nSales channel performance",
		'proves'      => 'Kelarix understands how FMCG and food-and-beverage leaders need connected visibility across demand, supply, and distribution.',
		'stat_label'  => 'Analytics Data',
		'stat_value'  => '91.2%',
		'is_featured' => false,
	),
	3 => array(
		...
		'explores'    => "Compliance case handling\nCustomer onboarding\nOperational risk tracking\nDocument approvals",
		'proves'      => 'Kelarix understands how financial services teams need structured workflow control across compliance-heavy operations.',
		'stat_label'  => 'Analytics Data',
		'stat_value'  => '88.5%',
		'is_featured' => false,
	),
	4 => array(
		...
		'explores'    => "Inventory usage patterns\nDepartment consumption\nCapacity visibility\nOperational exception tracking",
		'proves'      => 'Kelarix understands how healthcare operations need reliable, real-time visibility across inventory, usage, and capacity.',
		'stat_label'  => 'Analytics Data',
		'stat_value'  => '96.1%',
		'is_featured' => false,
	),
								...
								<div class="proof-analytics">
									...
									<div class="proof-chart">
										...
										<svg class="proof-chart__svg" viewBox="0 0 400 130" preserveAspectRatio="none">
											<defs>
												<linearGradient id="pc-grad-<?php echo (int) $i; ?>" x1="0" x2="0" y1="0" y2="1">
													<stop offset="0" stop-color="#1a48ff" stop-opacity=".22"/>
													<stop offset="1" stop-color="#1a48ff" stop-opacity="0"/>
												</linearGradient>
											</defs>
											<path d="M0 100 Q80 70 160 80 T320 40 T400 45 L400 130 L0 130 Z" fill="url(#pc-grad-<?php echo (int) $i; ?>)"/>
